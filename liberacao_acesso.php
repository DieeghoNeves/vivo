...
<?php
	...
	$result_cursos = "SELECT id, nome, email, eps, funcao, if(situacao = 0, 'Bloqueado', 'Desbloqueado') as situacao FROM db_sistema.usuarios";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <h5 class="align-middle text-center display-4">ACESSO AO SISTEMA</h5>
              </div>
            <div class="card-body">
            <table id="example2" class="table table-sm table table-hover">
                  ...
                  <tr class="bg-secondary text-white">  
                      <th>NOME COMPLETO</th>
                      <th class="text-sm-center text-md-center" >FUNÇÃO</th>
                      <th class="text-sm-center text-md-center" >EPS</th>
                      <th class="text-sm-center text-md-center" >STATUS</th>
                      <th class="text-sm-center text-md-center" >AÇÃO</th>
                  </tr>
                  </thead>
                  <tbody>
    <?php while($rows_cursos = mysqli_fetch_assoc($resultado_cursos)){ ?>
                  <tr>
                      <td><?php echo ucfirst(strtolower($rows_cursos['nome'])); ?></td>
                      <td class="text-sm-center text-md-center" ><?php echo utf8_encode($rows_cursos['funcao']); ?></td>
                      <td class="text-sm-center text-md-center" ><?php echo utf8_encode($rows_cursos['eps']); ?></td>
                      <td class="text-sm-center text-md-center" ><?php echo $rows_cursos['situacao']; ?></td> 
                      <td class="text-sm-center text-md-center" >
                        <form method="POST" action="http://177.74.128.249:8080/processa.php" enctype="multipart/form-data">
                          <input type="hidden" name="block" value="<?php echo $rows_cursos['id']; ?>">
                          <input type="submit" name="acesso" class="btn btn-xs btn-success" value="Desbloquear"></input>
                          <input type="submit" name="acesso" class="btn btn-xs btn-danger" value="Bloquear" ?></input>
                        </form>
									</td>
                  </tr>
                  <?php } ?> 
