...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="tec_efika.php" class="nav-link">Visão por tecnicos</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <span class="">Atualizado: 13-07  09:46</span>
        </a>
...
<tr>
  ...
  <div class="content-wrapper">
    ...
    <h3 class="card-header text-center">EFIKA FULL TESTE</h3>  <!-- class="fas fa-table aparece o icone da tabela    </br></br></br> -->
...
<?php
        $sql_criticos= "select *from efika_cidade";
        //echo $sql_criticos;
...
?> 
    ...
    <?php
        $sql_criticos= "select *from efika_eps";
        //echo $sql_criticos;
              ...
              <div class="card-body">
                <table class="table table-sm table table-bordered table table-hover">     
                  ...
                  <tr>
                      ...
                      <td class="text-sm-center align-middle text-center"><?php echo $result['producao']; ?></td> 
                      <td class="text-sm-center align-middle text-center"><?php echo $result['com_wif']; ?></td> 
                      <td class="text-sm-center align-middle text-center"><?php echo $result['porcentagem']; ?></td>
                  </tr>
                  <?php }  ?> 
                  </tbody>
