...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="tec_ofensores_wifi.php" class="nav-link">Visão por tecnicos</a>
      </li>
    </ul>
...
<tr>
  ...
  <div class="content-wrapper">
    ...
    <h1 class="card-header text-center">WIFI DESIGN</h1>  <!-- class="fas fa-table aparece o icone da tabela    </br></br></br> -->
    ...
    <?php
        $sql_criticos= "select *from efika_cluster";
        //echo $sql_criticos;
...
<?php
        $sql_criticos= "select *from wifi_cidade";
        //echo $sql_criticos;
...
?> 
                ...
                <table class="table table-sm table table-bordered table table-hover">
                  <thead>
                    <tr class="col-sm-12 bg-secondary text-white">  
                      ...
                      <th class="text-sm-center align-middle text-center ">COM WIFI DESIGN</th>
                  ...
                  <tr>
                      ...
                      <td class="text-sm-center align-middle text-center "><?php echo $result['%_com_wifi']; ?></td>
                  </tr>
                  <?php } ?> 
                    </tbody>
                </table>
    ...
    <?php
        $sql_criticos= "select *from wifi_eps";
        //echo $sql_criticos;
