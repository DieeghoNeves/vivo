...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="lig_indevidas.php" class="nav-link">Visão cidade eps</a>
      </li>
    </ul>
...
<?php
        $sql_criticos= "select *from tec_lig_indevidas";
        //echo $sql_criticos;
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="align-middle text-center display-4">LIGAÇÕES INDEVIDAS - OFENSORES</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12">
          <table id="example2" class="table table-sm table table-hover">
            ...
            <tr class="bg-secondary text-white">
                ...
                <th class="text-sm-center align-middle text-center">EPS</th>
                ...
                <th class="text-sm-center align-middle text-center">STATUS ATUAL</th>
                <th class="text-sm-center align-middle text-center">ABRIL</th>
                <th class="text-sm-center align-middle text-center">MAIO</th>
                <th class="text-sm-center align-middle text-center">STATUS</th>
                <th class="text-sm-center align-middle text-center">NOTA</th>
            </tr>
            </thead>
            <tbody>
<?php while($result = mysqli_fetch_assoc($query_criticos)){ ?>
            ...
            <td class="text-sm-left align-middle text-center"><?php echo $result['cidade']; ?></td>
                      ...
                      <td class="text-sm-center align-middle text-center"><?php echo $result['status_atual']; ?></td>
                      <td class="text-sm-center align-middle text-center"><?php echo $result['mes1']; ?></td>
                      <td class="text-sm-center align-middle text-center"><?php echo $result['mes2']; ?></td>
                      <td class="text-sm-center align-middle text-center"><?php echo $result['status']; ?></td>
                      <td class="text-sm-center align-middle text-center"><?php echo $result['nota']; ?></td>
            </tr>
            <?php } ?> 
          </table>
        </div>    
