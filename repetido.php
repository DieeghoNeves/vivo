  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <?php
        ...
        $dataR = date("d/m/Y H:i:s", filemtime("$path"));
      ?>
      <li class="nav-item">
        <a class="nav-link" data-widget="navbar-search" href="#" role="button">
        <span class=""><?php echo "Atualizado: -- {$dataR}";?></span>
        </a>
      ...
      <li class="nav-item dropdown">
       ...
       <!--  <span class="badge badge-danger navbar-badge">30-06-21</span> -->
        </a>
...
?> 
 ...
 <?php
        ...
        $sql_criticos= "select *from repetido_t_b";
        //echo $sql_criticos;
...
?> 
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="navbar-header float-right">
                    <a href="BASES_VIVO/IRR.xlsx" class="navbar-brand">
                        <small>
                            <img src="imagens/excel2.ico" width="30px">
                        </small>
                    </a>
                </div> 
              <h5 class="align-middle text-center">IRR - INDICADOR DE TT's REPETIDOS</h5>
            ...
            <table id="example2" class="table table-sm table table-hover">
                  ...
                  <tr class="bg-secondary text-white">
                      ...
                      <th class="text-sm-center text-md-center" >ENTRANTE<N/th>
                      <th class="text-sm-center text-md-center" >REPETIDO</th>
    ...
    <?php while($result = mysqli_fetch_assoc($query_criticos)){ ?>
                  <tr>
                      ...
                      <td class="text-sm-center text-md-center" ><?php echo utf8_encode( $result['sup']); ?></td> 
                      <td class="text-sm-center text-md-center" ><?php echo utf8_encode($result['penultimo_tec']); ?></td>
                      <td class="text-sm-center text-md-center" ><?php echo $result['entrante']; ?></td>
                      <td class="text-sm-center text-md-center" ><?php echo $result['repetido']; ?></td>
