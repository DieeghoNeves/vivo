  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <span class="">Atualizado: 17-07  09:05</span>
        </a>
...
<?php
        $sql_criticos= "select *from ispecao_rec";
        //echo $sql_criticos;
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h1 class="align-middle text-center">RECENTES PARA INSPEÇÃO</h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
                <table id="example2" class="table table-sm table table-hover">
                  ...
                  <tr class="bg-secondary text-white">
                      <th class="align-middle text-sm-center" >LOCALIDADE</th>   
                      <th class="align-middle" >RECURSO</th>
                      <th class="align-middle text-sm-center" >TROBLO TICKET</th>
                      <th class="align-middle text-center" >TELEFONE</th>
                      <th class="align-middle text-center" >N-BA</th>
                      <th class="align-middle text-center" >SEGMENTO<N/th>
                      <th class="align-middle text-center" >DIA ABERTURA</th>
                      <th class="align-middle text-center" >DATA CRIAÇAO</th>
                      <th class="align-middle" >ARMARIO</th>
                  </tr>
                  </thead>
                  <tbody>
    <?php while($result = mysqli_fetch_assoc($query_criticos)){ ?>
                  <tr>
                      <td class="text-sm-center" ><?php echo $result['localidade']; ?></td>
                      <td class="" ><?php echo utf8_encode($result['recurso']); ?></td>
                      <td class="text-sm-centert" ><?php echo utf8_encode($result['trouble_ticket']); ?></td>
                      <td class="text-sm-center" ><?php echo $result['telefone']; ?></td> 
                      <td class="text-sm-center" ><?php echo $result['nba']; ?></td> 
                      <td class="text-sm-center" ><?php echo $result['b2b_b2c']; ?></td>
                      <td class="text-sm-center" ><?php echo $result['dia_abertura']; ?></td>
                      <td class="text-sm-center" ><?php echo $result['data_criacao']; ?></td>
                      <td class="text-sm-center" ><?php echo $result['armario']; ?></td>
