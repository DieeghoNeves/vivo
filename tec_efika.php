...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="efika.php" class="nav-link">Visão cidade eps</a>
      </li>
    </ul>
...
?> 
  ...
  <div class="content-wrapper">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="align-middle text-center display-4">OFENSORES - EFIKA FULL TESTE</h5>
              </div>
            </div>
          </div>
        </div>
    ...
    <?php
  $sql_criticos= "select *from ofensores_full_teste";
  //echo $sql_criticos;
...
<?php while($result = mysqli_fetch_assoc($query_criticos)){ ?>
            <tr>
                ...
                <td class="text-sm-center align-middle text-center" ><?php echo utf8_encode($result['tecnico']); ?></td>
