  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <span class="">Atualizado: 20-07  09:05</span>
        </a>
...
?> 
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h1 class="align-middle text-center">RANKING DOS TECNICOS</h1>
              </div>
            </div>
          </div>
        </div>
 ...
 <?php
        ...
        $sql_criticos= "select *from ranking";
        //echo $sql_criticos;
...
?> 
            ...
            <div class="card-body">
                <table id="example2" class="table table-sm table table-hover">
                  ...
                  <tr class="bg-secondary text-white">
                      ...
                      <th class="text-sm-center align-middle text-left" >TECNICO</th>
    ...
    <?php while($result = mysqli_fetch_assoc($query_criticos)){ ?>
                  <tr>
                      ...
                      <td class="text-sm-center" ><?php echo utf8_encode($result['eps']); ?></td>
                      <td class="text-sm-center align-middle text-left" ><?php echo utf8_encode($result['tecnico']); ?></td>
